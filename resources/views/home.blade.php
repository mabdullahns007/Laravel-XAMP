...
<div class="profile d-flex justify-content-between ">
            ...
            <div class="mt-5 audio d-flex justify-content-center align-items-center flex-column">
                ...
                var username= document.getElementById("username");
                    ...
                    imgElement.src=`{{asset('uploads/thumbnails/${dataToDisplay[0][0].thumbnail}')}}`
                    audioElement.src=`{{asset('uploads/audios/${dataToDisplay[0][0].audio}')}}`
                    ...
                    document.onkeydown = (e) => {
                        ...
                        if (e.keyCode === 38) {
                            ...
                            imgElement.src=`{{asset('uploads/thumbnails/${image}')}}`
                            audioElement.src=`{{asset('uploads/audios/${audio}')}}`
