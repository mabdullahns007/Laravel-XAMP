...
.progress4 {
  ...
  <body>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    ...
                    <div class="col-lg-4">
                        <div class="card card1 mb-3 shadow">
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    <span class="fw-bold fs-1"><?php echo e($users); ?></span>
                                     last month
                                </p>
                            </div>
                        </div>                       
                    ...
                    <div class="col-lg-4">
                        <div class="card card2 mb-3 shadow">
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    <span class="fw-bold fs-1"><?php echo e($posts); ?></span>
                                     last week
                                </p>
                            </div>
                        </div>
                ...
                <footer class="mt-5 pt-3 border-top">
                    <p class="text-center">Copyright @ Ionut Cora - All Rights Reserved</p>
                </footer>
    ...
    <script src="<?php echo e(asset('js/chart3.js')); ?>"></script>
    <script src="<?php echo e(asset('js/chart4.js')); ?>"></script>
  </body>
</html><?php /**PATH C:\KAM 25\WORK PROFILE\5TH SEMESTER\Web Tech\LARAVEL\12\resources\views/admin.blade.php ENDPATH**/ ?>