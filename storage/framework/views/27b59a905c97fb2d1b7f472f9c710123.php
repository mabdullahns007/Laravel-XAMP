...
<body id="123">
    <div class="overlay animate__animated">
        ...
        <div class="Model">
            ...
            <p id="loginError"><?php echo e(session('status')); ?></p>
        </div>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
            <path fill="#802BB1" fill-opacity="1"
    ...
    <div class="type d-flex flex-column ">
        ...
        <div class="types d-flex justify-content-around pb-5">
            <div class="items">
                <div class="img"><img src="<?php echo e(asset('images/1.webp')); ?>" alt=""></div><span>Electronica &amp Dance</span>
            </div>
            <div class="items">
                <div class="img"><img src="<?php echo e(asset('images/2.webp')); ?>" alt=""></div><span>Film</span>
            </div>
            <div class="items">
                <div class="img"><img src="<?php echo e(asset('images/3.webp')); ?>" alt=""></div><span>Pop</span>
            </div>
            <div class="items">
                <div class="img"><img src="<?php echo e(asset('images/4.webp')); ?>" alt=""></div><span>Hip Hop</span>
            </div>
            <div class="items">
                <div class="img"><img src="<?php echo e(asset('images/5.webp')); ?>" alt=""></div><span>Voice Acting</span>
            </div>
            <div class="items">
                <div class="img"><img src="<?php echo e(asset('images/6.webp')); ?>" alt=""></div><span>Acoustic</span>
            </div>
        </div>
    </div>
    ...
    <div class="images d-flex justify-content-center mt-5 pt-5">
        <div class="imgItem"><img src="<?php echo e(asset('images/signup.jpg')); ?>" alt="">
            <div class="image-text">
                Unlock the world of sound. Join now!
            </div>
        </div>
        <div class="imgItem"><img src="<?php echo e(asset('images/upload.jpg')); ?>" alt="">
            <div class="image-text">
                Share your 12-second audio creation with the world.
            </div>
        </div>
        <div class="imgItem"><img src="<?php echo e(asset('images/explore.jpg')); ?>" alt="">
            <div class="image-text">
...
<?php if(session('status')=='Invalid Username or Password'): ?>
    openLoginForm()
<?php endif; ?>    
...
</html><?php /**PATH C:\KAM 25\WORK PROFILE\5TH SEMESTER\Web Tech\LARAVEL\12\resources\views/welcome.blade.php ENDPATH**/ ?>